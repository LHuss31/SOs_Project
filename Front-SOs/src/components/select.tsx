...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.ScrollUpButton ref={ref} className={`select-scroll-button ${className || ""}`} {...props}>
...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.ScrollDownButton ref={ref} className={`select-scroll-button ${className || ""}`} {...props}>
...
>(({ children, className, position = "popper", ...props }, ref) => (
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content ref={ref} className={`select-content ${className || ""}`} position={position} {...props}>
      ...
      <SelectPrimitive.Viewport className={`select-viewport ${position === "popper" ? "select-popper" : ""}`}>
        {children}
